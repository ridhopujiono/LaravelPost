				...
				<div id="kt_aside" class="aside aside-extended bg-white" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="auto" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
					...
					<div class="aside-primary d-flex flex-column align-items-lg-center flex-row-auto">
						...
						<div class="aside-logo d-none d-lg-flex flex-column align-items-center flex-column-auto pt-10" id="kt_aside_logo">
							<a href="index.html">
								<img alt="Logo" src="{{asset('theme/dist/assets/media/logos/logo-compact.svg')}}" class="h-55px" />
							</a>
						</div>
						<!--end::Logo-->
						<!--begin::Nav-->
							...
							<div class="d-flex align-items-stretch flex-shrink-0">
													...
													<div class="scroll-y mh-200px mh-lg-325px">
														...
														<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
															...
															<div class="symbol symbol-40px me-4">
																<img src="{{asset('theme/dist/assets/media/avatars/150-1.jpg')}}" alt="" />
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
														...
														<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
															<!--begin::Symbol-->
															<div class="symbol symbol-40px me-4">
																<img src="{{asset('theme/dist/assets/media/avatars/150-3.jpg')}}" alt="" />
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
															<div class="d-flex flex-column justify-content-start fw-bold">
														...
														<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
															<!--begin::Symbol-->
															<div class="symbol symbol-40px me-4">
																<img src="{{asset('theme/dist/assets/media/avatars/150-8.jpg')}}" alt="" />
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
															<div class="d-flex flex-column justify-content-start fw-bold">
														...
														<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
															<!--begin::Symbol-->
															<div class="symbol symbol-40px me-4">
																<img src="{{asset('theme/dist/assets/media/avatars/150-11.jpg')}}" alt="" />
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
															<div class="d-flex flex-column justify-content-start fw-bold">
														...
														<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
															<!--begin::Symbol-->
															<div class="symbol symbol-40px me-4">
																<img src="{{asset('theme/dist/assets/media/avatars/150-12.jpg')}}" alt="" />
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
															<div class="d-flex flex-column justify-content-start fw-bold">
														...
														<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
															...
															<div class="symbol symbol-40px me-4">
																<span class="symbol-label bg-light">
																	<img class="w-20px h-20px" src="{{asset('theme/dist/assets/media/svg/brand-logos/volicity-9.svg')}}" alt="" />
																</span>
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
														...
														<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
															...
															<div class="symbol symbol-40px me-4">
																<span class="symbol-label bg-light">
																	<img class="w-20px h-20px" src="{{asset('theme/dist/assets/media/svg/brand-logos/tvit.svg')}}" alt="" />
																</span>
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
														...
														<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
															...
															<div class="symbol symbol-40px me-4">
																<span class="symbol-label bg-light">
																	<img class="w-20px h-20px" src="{{asset('theme/dist/assets/media/svg/misc/infography.svg')}}" alt="" />
																</span>
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
														...
														<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
															...
															<div class="symbol symbol-40px me-4">
																<span class="symbol-label bg-light">
																	<img class="w-20px h-20px" src="{{asset('theme/dist/assets/media/svg/brand-logos/leaf.svg')}}" alt="" />
																</span>
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
														...
														<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
															...
															<div class="symbol symbol-40px me-4">
																<span class="symbol-label bg-light">
																	<img class="w-20px h-20px" src="{{asset('theme/dist/assets/media/svg/brand-logos/tower.svg')}}" alt="" />
																</span>
															</div>
															<!--end::Symbol-->
															<!--begin::Title-->
								...
								<div class="d-flex align-items-center ms-1 ms-lg-3">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
                                        ...
                                        background-image:
                                            url('{{asset(theme/dist/assets/media//misc/pattern-2.jpg)}}')
                                        ">
											<!--begin::Title-->
											...
											<div class="tab-pane fade" id="kt_topbar_notifications_2" role="tabpanel">
												...
												<div class="d-flex flex-column px-9">
													...
													<div class="text-center mb-5 px-4">
														<img class="mw-100 mh-175px" alt="" src="{{asset('theme/dist/assets/media/illustrations/verification.png')}}" />
													</div>
													<!--end::Illustration-->
												</div>
												<!--end::Wrapper-->
									...
									<div class="card card-xxl-stretch mb-5 mb-xxl-8">
										...
										<div class="card-body pt-5">
											...
											<div class="d-flex align-items-sm-center mb-9">
												...
												<div class="symbol symbol-50px me-5">
													<span class="symbol-label">
														<img src="{{asset('theme/dist/assets/media/svg/brand-logos/plurk.svg')}}" class="h-50 align-self-center" alt="" />
													</span>
												</div>
												<!--end::Symbol-->
												<!--begin::Section-->
											...
											<div class="d-flex align-items-sm-center mb-9">
												...
												<div class="symbol symbol-50px me-5">
													<span class="symbol-label">
														<img src="{{asset('theme/dist/assets/media/svg/brand-logos/telegram-2.svg')}}" class="h-50 align-self-center" alt="" />
													</span>
												</div>
												<!--end::Symbol-->
												<!--begin::Section-->
											...
											<div class="d-flex align-items-sm-center mb-9">
												...
												<div class="symbol symbol-50px me-5">
													<span class="symbol-label">
														<img src="{{asset('theme/dist/assets/media/svg/misc/puzzle.svg')}}" class="h-50 align-self-center" alt="" />
													</span>
												</div>
												<!--end::Symbol-->
												<!--begin::Section-->
											...
											<div class="d-flex align-items-sm-center mb-9">
												...
												<div class="symbol symbol-50px me-5">
													<span class="symbol-label">
														<img src="{{asset('theme/dist/assets/media/svg/brand-logos/bebo.svg')}}" class="h-50 align-self-center" alt="" />
													</span>
												</div>
												<!--end::Symbol-->
												<!--begin::Section-->
											...
											<div class="d-flex align-items-sm-center mb-0">
												...
												<div class="symbol symbol-50px me-5">
													<span class="symbol-label">
														<img src="{{asset('theme/dist/assets/media/svg/misc/infography.svg')}}" class="h-50 align-self-center" alt="" />
													</span>
												</div>
												<!--end::Symbol-->
												<!--begin::Section-->
															...
															<td class="p-0">
																<div class="d-flex align-items-center">
																	<div class="symbol symbol-50px me-2">
																		<span class="symbol-label">
																			<img alt="" class="w-25px" src="{{asset('theme/dist/assets/media/svg/misc/infography.svg')}}" />
																		</span>
																	</div>
																	<div class="ps-3">
														...
														<tr>
															...
															<td class="p-0">
																<div class="d-flex align-items-center">
																	<div class="symbol symbol-50px me-2">
																		<span class="symbol-label">
																			<img alt="" class="w-25px" src="{{asset('theme/dist/assets/media/svg/misc/recycling.svg')}}" />
																		</span>
																	</div>
																	<div class="ps-3">
														...
														<tr>
															...
															<td class="p-0">
																<div class="d-flex align-items-center">
																	<div class="symbol symbol-50px me-2">
																		<span class="symbol-label">
																			<img alt="" class="w-25px" src="{{asset('theme/dist/assets/media/svg/misc/eolic-energy.svg')}}" />
																		</span>
																	</div>
																	<div class="ps-3">
														...
														<tr>
															...
															<td class="p-0">
																<div class="d-flex align-items-center">
																	<div class="symbol symbol-50px me-2">
																		<span class="symbol-label">
																			<img alt="" class="w-25px" src="{{asset('theme/dist/assets/media/svg/brand-logos/leaf.svg')}}" />
																		</span>
																	</div>
																	<div class="ps-3">
										...
										<div class="card-body d-flex flex-column">
												...
												<div class="d-flex flex-stack pr-2 mb-5">
													...
													<div class="symbol symbol-50px">
														<div class="symbol-label">
															<img src="{{asset('theme/dist/assets/media/svg/brand-logos/treva.svg')}}" class="h-30px align-self-center" alt="" />
														</div>
													</div>
													<!--end::Symbol-->
												</div>
											...
											<div class="mt-13">
												...
												<a href="#" class="symbol symbol-40px me-2" data-bs-toggle="tooltip" title="Ricky Hunt">
													<img src="{{asset('theme/dist/assets/media/avatars/150-2.jpg')}}" alt="" />
												</a>
												<!--end::User-->
												<!--begin::User-->
												<a href="#" class="symbol symbol-40px me-2" data-bs-toggle="tooltip" title="Emma Smith">
													<img src="{{asset('theme/dist/assets/media/avatars/150-5.jpg')}}" alt="" />
												</a>
												<!--end::User-->
												<!--begin::User-->
												<a href="#" class="symbol symbol-40px me-2" data-bs-toggle="tooltip" title="Rudy Stone">
													<img src="{{asset('theme/dist/assets/media/avatars/150-6.jpg')}}" alt="" />
												</a>
												<!--end::User-->
												<!--begin::User-->
												<a href="#" class="symbol symbol-40px me-2" data-bs-toggle="tooltip" title="Brad Dennis">
													<img src="{{asset('theme/dist/assets/media/avatars/150-24.jpg')}}" alt="" />
												</a>
												<!--end::User-->
											</div>
											<!--end::Users-->
										...
										<div class="card-body d-flex flex-column">
											...
											<div class="flex-grow-1">
												...
												<div class="d-flex flex-stack pr-2 mb-5">
													...
													<div class="symbol symbol-50px">
														<div class="symbol-label">
															<img src="{{asset('theme/dist/assets/media/svg/misc/puzzle.svg')}}" class="h-30px align-self-center" alt="" />
														</div>
													</div>
													<!--end::Symbol-->
												</div>
										...
										<div class="card-body d-flex flex-column">
											...
											<div class="flex-grow-1">
												...
												<div class="d-flex flex-stack pr-2 mb-5">
													...
													<div class="symbol symbol-50px">
														<div class="symbol-label">
															<img src="{{asset('theme/dist/assets/media/svg/misc/recycling.svg')}}" class="h-30px align-self-center" alt="" />
														</div>
													</div>
													<!--end::Symbol-->
												</div>
											...
											<div class="mt-13">
												...
												<a href="#" class="symbol symbol-40px me-2" data-bs-toggle="tooltip" title="Kevin Leonard">
													<img src="{{asset('theme/dist/assets/media/avatars/150-13.jpg')}}" alt="" />
												</a>
												<!--end::User-->
												<!--begin::User-->
												...
												<a href="#" class="symbol symbol-40px me-2" data-bs-toggle="tooltip" title="Brad Simmons">
													<img src="{{asset('theme/dist/assets/media/avatars/150-17.jpg')}}" alt="" />
												</a>
												<!--end::User-->
											</div>
											<!--end::Users-->
									...
									<div class="pe-3 mb-5">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Nina Nilson">
												<img src="{{asset('theme/dist/assets/media/avatars/150-11.jpg')}}" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
									...
									<div class="overflow-auto pb-5">
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
											...
											<div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px pe-2">
												...
												<div class="symbol symbol-circle symbol-25px">
													<img src="{{asset('theme/dist/assets/media/avatars/150-3.jpg')}}" alt="img" />
												</div>
												<!--end::User-->
												<!--begin::User-->
												<div class="symbol symbol-circle symbol-25px">
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">
											...
											<div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
												<!--begin::User-->
												<div class="symbol symbol-circle symbol-25px">
													<img src="{{asset('theme/dist/assets/media/avatars/150-5.jpg')}}" alt="img" />
												</div>
												<!--end::User-->
												<!--begin::User-->
												<div class="symbol symbol-circle symbol-25px">
									...
									<div class="overflow-auto pe-3">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Alan Nilson">
												<img src="{{asset('theme/dist/assets/media/avatars/150-2.jpg')}}" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
									...
									<div class="mb-5 pe-3">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Jan Hummer">
												<img src="{{asset('theme/dist/assets/media/avatars/150-6.jpg')}}" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
									...
									<div class="overflow-auto pb-5">
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
											...
											<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
												<!--begin::Icon-->
												<img alt="" class="w-30px me-3" src="{{asset('theme/dist/assets/media/svg/files/pdf.svg')}}" />
												<!--end::Icon-->
												<!--begin::Info-->
											...
											<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
												<!--begin::Icon-->
												<img alt="" class="w-30px me-3" src="{{asset('theme/dist/assets/media/svg/files/doc.svg')}}" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-bold">
													<!--begin::Desc-->
											...
											<div class="d-flex flex-aligns-center">
												<!--begin::Icon-->
												<img alt="" class="w-30px me-3" src="{{asset('theme/dist/assets/media/svg/files/css.svg')}}" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-bold">
													<!--begin::Desc-->
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-7">
											...
											<div class="overlay me-10">
												...
												<div class="overlay-wrapper">
													<img alt="img" class="rounded w-100px" src="{{asset('theme/dist/assets/media/stock/300x270/1.jpg')}}" />
												</div>
												<!--end::Image-->
												<!--begin::Link-->
											...
											<div class="overlay me-10">
												<!--begin::Image-->
												<div class="overlay-wrapper">
													<img alt="img" class="rounded w-100px" src="{{asset('theme/dist/assets/media/stock/300x270/2.jpg')}}" />
												</div>
												<!--end::Image-->
												<!--begin::Link-->
												<div class="overlay-layer bg-dark bg-opacity-10 rounded">
											...
											<div class="overlay">
												<!--begin::Image-->
												<div class="overlay-wrapper">
													<img alt="img" class="rounded w-100px" src="{{asset('theme/dist/assets/media/stock/300x270/3.jpg')}}" />
												</div>
												<!--end::Image-->
												<!--begin::Link-->
												<div class="overlay-layer bg-dark bg-opacity-10 rounded">
									...
									<div class="pe-3 mb-5">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Robert Rich">
												<img src="{{asset('theme/dist/assets/media/avatars/150-14.jpg')}}" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
											...
											<div class="d-flex flex-column mb-7 fv-row">
												...
												<div class="position-relative">
													...
													<div class="position-absolute translate-middle-y top-50 end-0 me-5">
														<img src="{{asset('theme/dist/assets/media/svg/card-logos/visa.svg')}}" alt="" class="h-25px" />
														<img src="{{asset('theme/dist/assets/media/svg/card-logos/mastercard.svg')}}" alt="" class="h-25px" />
														<img src="{{asset('theme/dist/assets/media/svg/card-logos/american-express.svg')}}" alt="" class="h-25px" />
													</div>
													<!--end::Card logos-->
												</div>
												<!--end::Input wrapper-->
									...
									<div data-kt-stepper-element="content">
										<div class="w-100 text-center">
											...
											<div class="text-center mb-5 py-15 px-4">
												<img class="mw-100 mh-150px" alt="" src="{{asset('theme/dist/assets/media/illustrations/verification.png')}}" />
											</div>
											<!--end::Illustration-->
										</div>
									</div>
